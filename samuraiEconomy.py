...
class BankCog:
	...
	#THis should only be done by trusted bankers
	@commands.command()
...
class Bank:
	...
	def getAccountList(self):
		...
		for acnt in accounts:
			prettyAccounts+=acnt+" - "+str(self.accountList.get(acnt))+"\n"
	...
	def save(self, saveObj):
		with open('/home/cameron/Projets/Red-DiscordBot/cogs/samuraiCogs/bank.json','w') as fp:
			json.dump(saveObj,fp)

	def load(self):
		with open('/home/cameron/Projets/Red-DiscordBot/cogs/samuraiCogs/bank.json','r') as fp:
...
class AutomaticTransferMachine:
	...
	def __init__(self, bank):
		self.bankers=["Noremac","Nikodil","Centurion1", "TheHorseLord"]
		self.bank=bank
		self.transactions={}
		self.pageInfo={}
		self.load()
	...
	def pageUpdate(self,num):
		ScrapeForum(num)
		with open('/home/cameron/Projets/Red-DiscordBot/cogs/samuraiCogs/bankPageData.json','r') as fp:
	...
	def findCommands(self):
		...
		for p in self.pageInfo:
			...
			self.checkDeposit(post[0],name, pNum)
	...
	def save(self, saveObjects):
		with open('/home/cameron/Projets/Red-DiscordBot/cogs/samuraiCogs/transactions.json','w') as fp:
			json.dump(saveObjects,fp)

	def load(self):
		with open('/home/cameron/Projets/Red-DiscordBot/cogs/samuraiCogs/transactions.json','r') as fp:
...
class ScrapeForum:
	...
	def save(self, saveMe):
		with open('/home/cameron/Projets/Red-DiscordBot/cogs/samuraiCogs/bankPageData.json','w') as fp:
			json.dump(saveMe,fp)
